...
there. Slang rejects the attribute before it: `[ls_extent_2d("256", "128")] uniform Texture2D<float4>
...
Four rows are named `AlbedoMap`, and only the scope tells them apart. The `[ls_extent_2d]` annotation
